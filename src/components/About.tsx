    ...
    <section id="about" className="section">
      <div className="about-grid" style={{ maxWidth: 1200, margin: "0 auto" }}>
        <div data-reveal="">
          ...
          <p style={{ fontSize: 16.5, lineHeight: 1.75, color: "var(--text-2)", margin: "0 0 18px" }}>
          ...
          <p style={{ fontSize: 16.5, lineHeight: 1.75, color: "var(--text-2)", margin: 0 }}>
        ...
        <div data-reveal="" style={{ display: "grid", gap: 20 }}>
          <div style={{ padding: "28px 32px", background: "var(--card)", border: "1px solid rgba(var(--accent-rgb),.14)" }}>
            <div
              style={{
                fontFamily: "var(--font-space-grotesk), sans-serif",
                fontSize: 14,
            ...
            <ul style={{ margin: 0, padding: "0 0 0 18px", color: "var(--text-2)", fontSize: 15.5, lineHeight: 2 }}>
          ...
          <div style={{ padding: "28px 32px", background: "var(--card)", border: "1px solid rgba(var(--accent-rgb),.14)" }}>
            ...
            <div style={{ fontSize: 16, color: "var(--text)" }}>Edmond, Oklahoma, United States</div>
            <div style={{ fontSize: 14.5, color: "var(--muted)", marginTop: 4 }}>
